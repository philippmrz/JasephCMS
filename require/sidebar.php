...
<div id='navbar'>
  <ul>
    <li class='navlink'><a href='index'>frontpage</a></li>
    <?php if (isLoggedIn()):?>
    <li class='navlink'><a href='saved'>saved posts</a></li>
    <li class='navlink'><a href='myposts'>my posts</a></li>
    <li class='navlink'><a href='settings'>settings</a></li>
    <li class='navlink'><a href='newpost'>new post</a></li>
    <li></li>
    <?php endif;?>
  </ul>
</div>
